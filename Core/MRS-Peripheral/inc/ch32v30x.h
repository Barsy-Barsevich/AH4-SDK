...
#define RB_DVP_ENABLE			0x01U					// RW, DVP enable
#define RB_DVP_V_POLAR			0x02U					// RW, DVP VSYNC polarity control: 1 = invert, 0 = not invert
#define	RB_DVP_H_POLAR			0x04U					// RW, DVP HSYNC polarity control: 1 = invert, 0 = not invert
#define	RB_DVP_P_POLAR			0x08U					// RW, DVP PCLK polarity control: 1 = invert, 0 = not invert
#define RB_DVP_MSK_DAT_MOD		0x30U					
#define 	RB_DVP_D8_MOD			0x00U				// RW, DVP 8bits data mode
#define		RB_DVP_D10_MOD			0x10U				// RW, DVP 10bits data mode
#define		RB_DVP_D12_MOD			0x20U				// RW, DVP 12bits data mode
#define	RB_DVP_JPEG				0x40U					// RW, DVP JPEG mode

/*******************  Bit definition for DVP_CR1 register  ********************/
#define RB_DVP_DMA_EN			0x01U					// RW, DVP dma enable
#define RB_DVP_ALL_CLR			0x02U					// RW, DVP all clear, high action
#define	RB_DVP_RCV_CLR			0x04U					// RW, DVP receive logic clear, high action
#define RB_DVP_BUF_TOG			0x08U					// RW, DVP bug toggle by software, write 1 to toggle, ignored writing 0
#define RB_DVP_CM				0x10U					// RW, DVP capture mode
#define	RB_DVP_CROP				0x20U					// RW, DVP Crop feature enable
#define RB_DVP_FCRC				0xC0U					// RW, DVP frame capture rate control: 
#define		DVP_RATE_100P		0x00U					//00 = every frame captured (100%) 
#define		DVP_RATE_50P		0x40U					//01 = every alternate frame captured (50%)
#define		DVP_RATE_25P		0x80U					//10 = one frame in four frame captured (25%)

/*******************  Bit definition for DVP_IER register  ********************/
#define	RB_DVP_IE_STR_FRM		0x01U					// RW, DVP frame start interrupt enable
#define	RB_DVP_IE_ROW_DONE		0x02U					// RW, DVP row received done interrupt enable
#define RB_DVP_IE_FRM_DONE		0x04U					// RW, DVP frame received done interrupt enable
#define	RB_DVP_IE_FIFO_OV		0x08U					// RW, DVP receive fifo overflow interrupt enable	
#define RB_DVP_IE_STP_FRM		0x10U					// RW, DVP frame stop interrupt enable				

/*******************  Bit definition for DVP_IFR register  ********************/
#define RB_DVP_IF_STR_FRM	    0x01U				    // RW1, interrupt flag for DVP frame start
#define RB_DVP_IF_ROW_DONE		0x02U				    // RW1, interrupt flag for DVP row receive done
#define RB_DVP_IF_FRM_DONE		0x04U				    // RW1, interrupt flag for DVP frame receive done
#define RB_DVP_IF_FIFO_OV		0x08U				    // RW1, interrupt flag for DVP receive fifo overflow
#define RB_DVP_IF_STP_FRM		0x10U				    // RW1, interrupt flag for DVP frame stop

/*******************  Bit definition for DVP_STATUS register  ********************/
#define RB_DVP_FIFO_RDY			0x01U					// RO, DVP receive fifo ready
#define RB_DVP_FIFO_FULL		0x02U					// RO, DVP receive fifo full
#define RB_DVP_FIFO_OV			0x04U					// RO, DVP receive fifo overflow
#define RB_DVP_MSK_FIFO_CNT		0x70U					// RO, DVP receive fifo count
