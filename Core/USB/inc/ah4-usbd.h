...
#define DEF_UEP_OUT                   0x00U
/* Endpoint Number */
#define DEF_UEP_BUSY                  0x01U
#define DEF_UEP_FREE                  0x00U
#define DEF_UEP_NUM                   16U
#define DEF_UEP0                      0x00U
#define DEF_UEP1                      0x01U
#define DEF_UEP2                      0x02U
#define DEF_UEP3                      0x03U
#define DEF_UEP4                      0x04U
#define DEF_UEP5                      0x05U
#define DEF_UEP6                      0x06U
#define DEF_UEP7                      0x07U
#define DEF_UEP8                      0x08U
#define DEF_UEP9                      0x09U
#define DEF_UEP10                     0x0AU
#define DEF_UEP11                     0x0BU
#define DEF_UEP12                     0x0CU
#define DEF_UEP13                     0x0DU
#define DEF_UEP14                     0x0EU
#define DEF_UEP15                     0x0FU

#define USBHSD_UEP_CFG_BASE           0x40023410U
#define USBHSD_UEP_BUF_MOD_BASE       0x40023418U
#define USBHSD_UEP_RXDMA_BASE         0x40023420U
#define USBHSD_UEP_TXDMA_BASE         0x4002345CU
#define USBHSD_UEP_TXLEN_BASE         0x400234DCU
#define USBHSD_UEP_TXCTL_BASE         0x400234DEU
#define USBHSD_UEP_TX_EN( N )         ( (uint16_t)( 0x01U << N ) )
#define USBHSD_UEP_RX_EN( N )         ( (uint16_t)( 0x01U << ( N + 16 ) ) )
#define USBHSD_UEP_DOUBLE_BUF( N )    ( (uint16_t)( 0x01U << N ) )
...
#define USBHSD_UEP_RXDMA( N )         ( *((volatile uint32_t *)( USBHSD_UEP_RXDMA_BASE + ( N - 1 ) * 0x04U ) ) )
#define USBHSD_UEP_RXBUF( N )         ( (uint8_t *)(*((volatile uint32_t *)( USBHSD_UEP_RXDMA_BASE + ( N - 1 ) * 0x04U ) ) ) + 0x20000000U )
#define USBHSD_UEP_TXCTRL( N )        ( *((volatile uint8_t *)( USBHSD_UEP_TXCTL_BASE + ( N - 1 ) * 0x04U ) ) )
#define USBHSD_UEP_TXDMA( N )         ( *((volatile uint32_t *)( USBHSD_UEP_TXDMA_BASE + ( N - 1 ) * 0x04U ) ) )
#define USBHSD_UEP_TXBUF( N )         ( (uint8_t *)(*((volatile uint32_t *)( USBHSD_UEP_TXDMA_BASE + ( N - 1 ) * 0x04U ) ) ) + 0x20000000U )
#define USBHSD_UEP_TLEN( N )          ( *((volatile uint16_t *)( USBHSD_UEP_TXLEN_BASE + ( N - 1 ) * 0x04U ) ) )

// USB SPEED TYPE
#define USBHS_SPEED_TYPE_MASK         ((uint8_t)(0x03U))
#define USBHS_SPEED_LOW               ((uint8_t)(0x02U))
#define USBHS_SPEED_FULL              ((uint8_t)(0x00U))
#define USBHS_SPEED_HIGH              ((uint8_t)(0x01U))
...
#define DEF_UARTx_RX_BUF_LEN       ( 4 * 512U )                                  /* Serial x receive buffer size */
#define DEF_UARTx_TX_BUF_LEN       ( 2 * 512U )                                  /* Serial x transmit buffer size */
...
#define DEF_UARTx_BAUDRATE         115200U                                       /* Default baud rate for serial port */
#define DEF_UARTx_STOPBIT          0U                                            /* Default stop bit for serial port */
#define DEF_UARTx_PARITY           0U                                            /* Default parity bit for serial port */
#define DEF_UARTx_DATABIT          8U                                            /* Default data bit for serial port */
#define DEF_UARTx_RX_TIMEOUT       30U                                           /* Serial port receive timeout, in 100uS */
#define DEF_UARTx_USB_UP_TIMEOUT   60000U                                        /* Serial port receive upload timeout, in 100uS */
